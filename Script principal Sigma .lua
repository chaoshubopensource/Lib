...
--     warn("❌ This script must only be executed from the offical Sigma Boy loader")
--         return
--     end
...
-- _G.__userKey = nil
print("✅ Security verification passed. Loading Sigma Boy...")
...
-- print("--------------------------------------------------------------------------");
local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/chaoshubopensource/Lib/refs/heads/main/lib2.lua")))();
...
(getgenv()).Load = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Sigma Boy") then
			makefolder("Sigma Boy");
		end;
		if not isfolder("Sigma Boy/Blox Fruits/") then
			makefolder("Sigma Boy/Blox Fruits/");
		end;
		if not isfile(("Sigma Boy/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Sigma Boy/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(_G.Settings));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Sigma Boy/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"));
	...
	if Update:SaveSettings() then
		if readfile and writefile and isfile and isfolder then
			if not isfile(("Sigma Boy/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json")) then
				...
				writefile("Sigma Boy/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
			end;
		else
			return warn("Status : Undetected Executor");
		end;
