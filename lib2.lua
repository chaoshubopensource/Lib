if (game:GetService("CoreGui")):FindFirstChild("Sigma Boy Hub") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then
	(game:GetService("CoreGui")).Sigma Boy Hub:Destroy();
...
ImageButton.Image = "rbxassetid://74542926893496";
ImageButton.AutoButtonColor = false;
MakeDraggable(ImageButton, OutlineButton);
CreateRounded(ImageButton, 10);
ImageButton.MouseButton1Click:connect(function()
	(game.CoreGui:FindFirstChild("Sigma Boy Hub")).Enabled = not (game.CoreGui:FindFirstChild("Sigma Boy Hub")).Enabled;
end);
...
function Update:StartLoad()
	...
	TitleLoader.Text = "Sigma Boy Hub";
...
(getgenv()).LoadConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Sigma Boy Hub") then
			makefolder("Sigma Boy Hub");
		end;
		if not isfolder("Sigma Boy Hub/Library/") then
			makefolder("Sigma Boy Hub/Library/");
		end;
		if not isfile(("Sigma Boy Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			writefile("Sigma Boy Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));
		else
			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Sigma Boy Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	if readfile and writefile and isfile and isfolder then
		if not isfile(("Sigma Boy Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("Sigma Boy Hub/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
		end;
	else
		return warn("Status : Undetected Executor");
	end;
...
function Update:Window(Config)
	...
	local Sigma Boy Hub = Instance.new("ScreenGui");
	Sigma Boy Hub.Name = "Sigma Boy Hub";
	Sigma Boy Hub.Parent = game.CoreGui;
	Sigma Boy Hub.DisplayOrder = 999;
	local OutlineMain = Instance.new("Frame");
	OutlineMain.Name = "OutlineMain";
	OutlineMain.Parent = Sigma Boy Hub;
	...
	CreateButton("Reset Config", function()
		if isfolder("Sigma Boy Hub") then
			delfolder("Sigma Boy Hub");
		end;
